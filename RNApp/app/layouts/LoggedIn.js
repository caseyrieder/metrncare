...
import { Icon as ExercisesIcon } from '../routes/Exercises';
// import { Icon as DocumentationIcon } from '../routes/Documentation';
  ...
  render() {
    return (
      <TabNavigator>
        ...
        {this.renderTabItem('Exercises', Routes.getExercisesRoute(), ExercisesIcon)}
